<template>
  <div class="article-container">
    ...
    question), and <em>intonation</em>. As an L2 speaker, accent is arguably the
    most difficult aspect of language to fully master. The term “native accent”
    is vague, as native speakers of a language will pronounce the language
    differently depending on their generation, social class, specific area, and
    personality. That said, talking to an unsuspecting native speaker on the
    phone and seeing if they notice that you are an L2 speaker or not is a
    ...
    motivation also seem to play a large role. Consciously studying the phonetic
    system of the target language may allow one to become able to perceive and
    notice greater levels of subtlety when getting input, leading to acquiring a
    more native-like accent. Techniques such as <em>adopting a parent</em> and
    <em>shadowing</em> can also help one obtain a more native-like accent, but
    require a basic level of proficiency in the language to be effective.
    ...
    one of the five hypotheses that constitute the <em>input hypothesis</em>.
    The <em>acquisition–learning hypothesis</em> claims that people can develop
    ...
    recognize that anything has changed immediately after the fact. Acquisition
    is most likely to occur when one is meaningfully engaged in the message
    (rather than the form) of linguistic input, e.g., when engrossed in a TV
    show or deep in a thought-provoking conversation. While “you” are busy
    following the plot or formulating arguments, a deeper part of the mind is
    working hard to decode the nuances of language. Subjectively, acquisition
    manifests itself in the form of linguistic intuitions you can’t logically
    ...
    to "think" about anything to know which of the two phrases is most natural;
    you <em>just knew</em>. In this way, accessing what one has acquired is, in
    most cases, instantaneous, effortless and direct.

    <hr />

    <h2>Active Immersion</h2>
    <em>Active Immersion</em> is one of the three main categories of Immersion,
    along with <em>Passive Immersion</em> and <em>Background Immersion</em>. Any
    time that one’s <strong>full and undivided attention</strong> is being
    directed towards an activity that is directly mediated by the target
    language, one is getting Active Immersion. Some examples include sitting
    down and reading a book, watching a movie or TV show without multitasking,
    or having a conversation with a native speaker. Whether one is simply
    getting lost in the <em>content</em> of input (e.g., enjoying the plot of a
    novel like a native speaker would) or heavily focusing on the
    <em>form</em> of input (e.g., analyzing intonation patterns while listening
    ...
    one is regularly getting significant doses of Active Immersion. This is why
    Active Immersion is the linchpin of MIA and language acquisition as a whole.
    Without Active Immersion, one will get nowhere; if one did
    ...
    guide, watching a pronunciation tutorial on YouTube, or looking words up in
    a dictionary and creating Sentence Cards. In MIA, Active Study mostly
    revolves around making and reviewing SRS cards, although this is not always
    the case. Mastering a language without Active Study is possible, and there
    are examples of people successfully acquiring foreign languages through
    Immersion alone. That said, MIA's stance is that Active Study,
    <strong>when properly combined with Immersion</strong>, greatly accelerates
    the acquisition process. It is also worth noting that the value of Active
    Study decreases as one becomes more advanced in the language.

    <hr />

    <h2>AJATT</h2>
    AJATT, short for “All Japanese All the Time,” is a language learning blog
    created by Khatzumoto in 2006. The goal of AJATT was to document and improve
    upon the methods Khatzumoto used to become fluent in Japanese in the short
    span of 18 months. The method that he described (later known as “The AJATT
    Method”) was very similar to the <em>Antimoon</em> method, with the addition
    of James Heisig’s <em>Remembering the Kanji</em> and an emphasis on mindset
    and the psychology of success. Khatzumoto stressed the importance of being
    self-directed, creative, and willing to experiment. He argued that
    extraordinary results can’t be achieved with ordinary action, and encouraged
    people not to be held back by the desire for social acceptance. Above all,
    the bedrock of AJATT was the assertion that enjoying the process is an
    absolutely essential ingredient for success. Unfortunately, this greater
    message was lost on many, which resulted in AJATT becoming polarizing and
    controversial. Nevertheless, AJATT had a large impact on late 00’s Japanese
    learning community, popularizing the SRS and <em>Remembering the Kanji</em>,
    and spreading awareness of Stephen Krashen’s <em>Input Hypothesis</em>.
    Although AJATT began as a free blog, around 2010, Khatzumoto shifted his
    focus to creating questionable language learning products, which he sold
    with sleazy marketing techniques at unreasonably high prices. This
    aggressive marketing led many to mistakenly assume that all of AJATT,
    including the original free content, was nothing more than a scam, severely
    ...
    users to improperly grade cards and greatly hurt the effectiveness of the
    algorithm. This is exacerbated by the default algorithm settings being
    borderline nonsensical (Maximum reviews/day set to 200, New Interval set to
    0%, etc.) Anki is MIA’s recommended SRS. The main reasons for this are the
    accessibility (it’s free and runs on all platforms), customizability (cards
    ...
    word or structure is referred to as the "target word" or "target structure".
    A sentence is only considered to be 1T if, after looking up or inferring the
    meaning of the unknown word/structure, the overall meaning of the sentence
    becomes clear. If a sentence contains one unknown word/structure, but the
    overall meaning remains unclear even after looking up the target
    word/structure, the sentence is not considered to be 1T. Learning through 1T
    sentences can be thought of as "picking low-hanging fruit". It makes the
    target word/structure easy to understand and retain. As you continue to
    learn, sentences that were previously one-target will become zero-target,
    and sentences that were previously multi-target will become one-target. In
    this way, one-target sentences can take you all the way to fluency.
    ...
    where "i" is the learner's interlanguage and "+1" is the next stage of
    language acquisition." In other words, Krashen's "i+1" refers to input that
    is immediately comprehensible to the unconscious language acquisition
    device. On the other hand, MIA was using the term to refer to input that
    could be consciously comprehended after looking up or inferring the meaning
    of an unknown word or structure. In order to avoid confusion due to this
    ...
    a target word or target structure. If you know all the words/structures
