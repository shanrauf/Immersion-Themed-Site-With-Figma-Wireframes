<template>
  <div>
    ...
    Note: what I meant to say at the end is that it's not contradictory to say
    that it <strong>MAY</strong> be the case that, while there are universal
    principals of language acquisition that are true for everyone, certain
    specific methods may be more cut out for some people than for others.
    ...
    people who have successfully accomplished “x”. A corollary of this is that,
    even if someone hasn’t reached the highest possible levels of foreign
    language mastery, as long as they have reached a level you would be happy
    ...
    take personal responsibility for your learning and results.
